...
const APP = {
	...
	INVOICING: {
		...
		TRANSACTIONS: lazy(() => import('../pages/presentation/invoicing/Transactions')),
		PENDING_PAYMENTS_DETAIL: lazy(() => import('../pages/presentation/invoicing/PendingPaymentsDetail')),
...
const presentation: RouteProps[] = [
	 ...
	 */
	// {
	// 	path: demoPagesMenu.invoicing.subMenu.billingInfo.path,
	// 	element: <APP.INVOICING.BILLING_INFO />,
	// },
	{
		path: demoPagesMenu.invoicing.subMenu.pendingPayments.path,
		element: <APP.INVOICING.PENDING_PAYMENTS />,
	},
	{
		path: demoPagesMenu.invoicing.subMenu.transactions.path,
		element: <APP.INVOICING.TRANSACTIONS />,
	},
	{
		path: `${demoPagesMenu.invoicing.subMenu.pendingPaymentsDetail.path}/:id`,
		element: <APP.INVOICING.PENDING_PAYMENTS_DETAIL />,
	},
	{
		path: `${demoPagesMenu.invoicing.subMenu.transactionsDetail.path}/:id`,
		element: <APP.INVOICING.TRANSACTIONS_DETAIL />,
	},
