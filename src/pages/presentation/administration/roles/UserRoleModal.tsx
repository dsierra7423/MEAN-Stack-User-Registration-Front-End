...
import { assignUserToARole, getUsersOAuth } from '../../../../helpers/requests';
...
const UserRoleModal: FC<IUserRoleModalProps> = ({ isOpen, setIsOpen, setUpdateTable, usersRol, role_id }) => {
    ...
    const addUser = async(user_id: string, role_id: string) => {
        assignUserToARole(user_id, role_id).then(response => {
            if(!response.err){
                                        ...
                                        <Button
                                            ...
                                            onClick={() => {
                                                if (role_id != undefined && role_id != null) {
                                                    const roleId = (role_id.split('-'))[1];
                                                    addUser(user.user_id, roleId);
                                                }
                                            }}>
                                        </Button>
                                    </td>
