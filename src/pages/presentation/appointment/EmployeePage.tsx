...
import { helpHttp, priceFormat } from '../../../helpers/helpers';
...
const EmployeePage = () => {
	...
	return (
		<PageWrapper title={`${dataUserProfile.name ? dataUserProfile.name : data.name}`}>
			<SubHeader>
				<SubHeaderLeft>
					<Button
						color='info'
			...
			<Page>
				<div className='pt-3 pb-5 d-flex align-items-center'>
					<span className='display-4 fw-bold me-3'>{`${dataUserProfile.name ? dataUserProfile.name : ''}`}</span>
				</div>
				<div className='row'>
										...
										<div className='row g-2'>
											...
											<div className='col-12'>
												<div className='d-flex align-items-center'>
													...
													<div className='flex-grow-1 ms-3'>
														<div className='fw-bold fs-5 mb-0'>
															{dataUserProfile.family_name
																? dataUserProfile.family_name
																: ''
															}
														</div>
														<div className='text-muted'>
															{t('Family Name') as ReactNode}
														</div>
													</div>
												</div>
											</div>
											<div className='col-12'>
												<div className='d-flex align-items-center'>
													<div className='flex-shrink-0'>
														<Icon icon='Face' size='3x' color='info' />
													</div>
													<div className='flex-grow-1 ms-3'>
														<div className='fw-bold fs-5 mb-0'>
															{dataUserProfile.given_name
																? dataUserProfile.given_name
																: ''
															}
														</div>
														<div className='text-muted'>
															{t('Given Name') as ReactNode}
														</div>
													</div>
												</div>
											</div>
