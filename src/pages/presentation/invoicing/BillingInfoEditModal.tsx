...
interface IBillingInfoEditModalProps {
	id: string;
	isOpen: boolean;
	setIsOpen(...args: unknown[]): unknown;
}
const BillingInfoEditModal: FC<IBillingInfoEditModalProps> = ({ id, isOpen, setIsOpen }) => {
							...
							<Card className='rounded-1 mb-0'>
								...
								<CardBody>
									<div className='row g-3'>
										...
										<FormGroup id='city' label='City' className='col-md-3'>
											<Input
												onChange={formik.handleChange}
										...
										<FormGroup id='zip' label='Zip' className='col-md-3'>
											<Input
												onChange={formik.handleChange}
...
BillingInfoEditModal.propTypes = {
