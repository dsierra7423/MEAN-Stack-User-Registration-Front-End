...
export const demoPagesMenu = {
	...
	invoicing: {
		...
		subMenu: {
			...
			// 	path: 'invoicing/billing-info',
			// 	icon: 'Description',
			// },
			pendingPayments: {
				id: 'pendingPayments',
				text: 'Pending Payments',
				path: 'invoicing/payments/pending-payments',
				icon: 'CreditCard',
			},
			transactions: {
				id: 'transactions',
				text: 'Transactions',
				path: 'invoicing/payments/transactions',
				icon: 'RequestQuote',
			},
			pendingPaymentsDetail: {
				id: 'pendingPaymentsDetail',
				text: 'Pending Payments Detail',
				path: 'invoicing/payments/pending-payments-detail',
				hide: true,
			},
			transactionsDetail: {
				id: 'transactionsDetail',
				text: 'Transactions Detail',
				path: 'invoicing/payments/transactions-detail',
				hide: true,
			},
			subscriptions: {
				id: 'subscriptions',
